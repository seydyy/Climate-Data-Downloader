{
 "cells": [
  {
   "cell_type": "markdown",
   "id": "459d1034-3d5c-429b-bab2-287c9c5c106f",
   "metadata": {},
   "source": [
    "## Module requires"
   ]
  },
  {
   "cell_type": "code",
   "execution_count": 1,
   "id": "f901f919-0ff7-43ae-9f82-1dfb1e9bf861",
   "metadata": {},
   "outputs": [
    {
     "name": "stdout",
     "output_type": "stream",
     "text": [
      "Requirement already satisfied: cdsapi in c:\\users\\lenovo\\anaconda3\\lib\\site-packages (0.7.7)Note: you may need to restart the kernel to use updated packages.\n",
      "\n",
      "Requirement already satisfied: xarray in c:\\users\\lenovo\\anaconda3\\lib\\site-packages (2025.4.0)\n",
      "Requirement already satisfied: netCDF4 in c:\\users\\lenovo\\anaconda3\\lib\\site-packages (1.7.4)\n",
      "Requirement already satisfied: ecmwf-datastores-client>=0.4.0 in c:\\users\\lenovo\\anaconda3\\lib\\site-packages (from cdsapi) (0.4.2)\n",
      "Requirement already satisfied: requests>=2.5.0 in c:\\users\\lenovo\\anaconda3\\lib\\site-packages (from cdsapi) (2.32.3)\n",
      "Requirement already satisfied: tqdm in c:\\users\\lenovo\\anaconda3\\lib\\site-packages (from cdsapi) (4.67.1)\n",
      "Requirement already satisfied: numpy>=1.24 in c:\\users\\lenovo\\anaconda3\\lib\\site-packages (from xarray) (2.1.3)\n",
      "Requirement already satisfied: packaging>=23.2 in c:\\users\\lenovo\\anaconda3\\lib\\site-packages (from xarray) (24.2)\n",
      "Requirement already satisfied: pandas>=2.1 in c:\\users\\lenovo\\anaconda3\\lib\\site-packages (from xarray) (2.2.3)\n",
      "Requirement already satisfied: cftime in c:\\users\\lenovo\\anaconda3\\lib\\site-packages (from netCDF4) (1.6.5)\n",
      "Requirement already satisfied: certifi in c:\\users\\lenovo\\anaconda3\\lib\\site-packages (from netCDF4) (2025.4.26)\n",
      "Requirement already satisfied: attrs in c:\\users\\lenovo\\anaconda3\\lib\\site-packages (from ecmwf-datastores-client>=0.4.0->cdsapi) (24.3.0)\n",
      "Requirement already satisfied: multiurl>=0.3.7 in c:\\users\\lenovo\\anaconda3\\lib\\site-packages (from ecmwf-datastores-client>=0.4.0->cdsapi) (0.3.7)\n",
      "Requirement already satisfied: typing-extensions in c:\\users\\lenovo\\anaconda3\\lib\\site-packages (from ecmwf-datastores-client>=0.4.0->cdsapi) (4.12.2)\n",
      "Requirement already satisfied: pytz in c:\\users\\lenovo\\anaconda3\\lib\\site-packages (from multiurl>=0.3.7->ecmwf-datastores-client>=0.4.0->cdsapi) (2024.1)\n",
      "Requirement already satisfied: python-dateutil in c:\\users\\lenovo\\anaconda3\\lib\\site-packages (from multiurl>=0.3.7->ecmwf-datastores-client>=0.4.0->cdsapi) (2.9.0.post0)\n",
      "Requirement already satisfied: tzdata>=2022.7 in c:\\users\\lenovo\\anaconda3\\lib\\site-packages (from pandas>=2.1->xarray) (2025.2)\n",
      "Requirement already satisfied: six>=1.5 in c:\\users\\lenovo\\anaconda3\\lib\\site-packages (from python-dateutil->multiurl>=0.3.7->ecmwf-datastores-client>=0.4.0->cdsapi) (1.17.0)\n",
      "Requirement already satisfied: charset-normalizer<4,>=2 in c:\\users\\lenovo\\anaconda3\\lib\\site-packages (from requests>=2.5.0->cdsapi) (3.3.2)\n",
      "Requirement already satisfied: idna<4,>=2.5 in c:\\users\\lenovo\\anaconda3\\lib\\site-packages (from requests>=2.5.0->cdsapi) (3.7)\n",
      "Requirement already satisfied: urllib3<3,>=1.21.1 in c:\\users\\lenovo\\anaconda3\\lib\\site-packages (from requests>=2.5.0->cdsapi) (2.3.0)\n",
      "Requirement already satisfied: colorama in c:\\users\\lenovo\\anaconda3\\lib\\site-packages (from tqdm->cdsapi) (0.4.6)\n"
     ]
    }
   ],
   "source": [
  ...
  {
   "cell_type": "markdown",
   "id": "a860a51a-285f-4c5e-87eb-8b3675d55cde",
   "metadata": {},
   "source": [
    "## Documentation"
   ]
  },
  {
   ...
   "id": "7c627b53-181e-4874-af58-adb6e46004a1",
   "metadata": {},
   "outputs": [],
   "source": [
    "\"\"\"\n",
  ...
  {
   "cell_type": "markdown",
   "id": "039109c3-e67b-4ebc-9b83-9927f1c86925",
   "metadata": {},
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "bd3b4290-ccb6-4ccb-aea1-24c52bed48ca",
   "metadata": {},
   "outputs": [],
   "source": [
    "import argparse\n",
  ...
  {
   "cell_type": "markdown",
   "id": "c7b89a13-b8b8-4e6e-a9d1-559c3d5456a9",
   "metadata": {},
   "source": [
    "## Logging"
   ]
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "dcfe0a67-7ee2-4138-8d38-c71b967e08c7",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  {
   "cell_type": "markdown",
   "id": "452b6586-b2c9-4219-90af-e6305e15945c",
   "metadata": {},
   "source": [
    "## CONFIGURATION "
   ]
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "8fc4e35f-d455-4090-873e-2c8d3732531a",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  {
   "cell_type": "markdown",
   "id": "53c1ca9f-e4da-4029-a180-bf01918b3b6f",
   "metadata": {},
   "source": [
    "## DOWNLOAD FUNCTIONS"
   ]
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "c8fb2de4-0e9f-4bb0-ba57-0c458db51fed",
   "metadata": {},
   "outputs": [],
   "source": [
    "\n",
  ...
  {
   "cell_type": "markdown",
   "id": "e893ea79-4f7b-41e7-8cb3-79bcb933b9cc",
   "metadata": {},
   "source": [
    "## VERIFICATION"
   ]
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "ecf51545-2e1e-4cdc-be89-65cd31170581",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 1,
   "id": "21f522f9-92d4-433b-9987-7e899f307e2f",
   "metadata": {},
   "outputs": [
    {
     "name": "stderr",
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 2,
   "id": "ec936fca-475e-480d-968b-7297f9c2fb73",
   "metadata": {},
   "outputs": [
    {
     "ename": "FileNotFoundError",
     "evalue": "[Errno 2] No such file or directory: 'era5_land.py'",
     "output_type": "error",
     "traceback": [
      "\u001b[1;31m---------------------------------------------------------------------------\u001b[0m",
      "\u001b[1;31mFileNotFoundError\u001b[0m                         Traceback (most recent call last)",
      "Cell \u001b[1;32mIn[2], line 2\u001b[0m\n\u001b[0;32m      1\u001b[0m \u001b[38;5;66;03m# Cellule 1 — Importer les fonctions\u001b[39;00m\n\u001b[1;32m----> 2\u001b[0m exec(\u001b[38;5;28mopen\u001b[39m(\u001b[38;5;124m\"\u001b[39m\u001b[38;5;124mera5_land.py\u001b[39m\u001b[38;5;124m\"\u001b[39m)\u001b[38;5;241m.\u001b[39mread())\n",
      ...
      "\u001b[1;31mFileNotFoundError\u001b[0m: [Errno 2] No such file or directory: 'era5_land.py'"
     ]
    }
   ],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "7c443f6f-56e9-4147-9fb9-38560e08d43f",
   "metadata": {},
   "outputs": [],
   "source": []
  }
